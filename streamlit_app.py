#!/usr/bin/env python3
"""
Luminate Email Banner Processor - Streamlit Web App

A user-friendly web interface for processing marathon photos into
email-optimized banners with intelligent face detection.
...
# Page configuration
st.set_page_config(
    page_title="Luminate Email Banner Processor",
    page_icon="🏃",
    layout="wide",
...
def main():
    # Header
    st.title("🏃 Luminate Email Banner Processor")
    st.markdown("""
    ...
    **Standard:** {target_width} × {target_height} px  
    ...
    <div style="text-align: center; color: #888; font-size: 0.9em;">
        <p>Luminate Email Banner Processor • Built with Streamlit</p>
